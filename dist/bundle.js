...
/***/ function(module, exports, __webpack_require__) {
	...
	var Form = exports.Form = _react2.default.createClass({
	    ...
	    exchange: function exchange(array, a, b) {
	    ...
	    b: function b(X) {
	        var n = (X - i / 2) / i;
	        result[e.id].indent + n * i >= 0 ? setState({
	            offsetIndent: n * i
	        }) : setState({
	    ...
	    sortToDoList: function sortToDoList(e, X, Y) {
	        //e.type=task -left +right -up +down
	        X > i / 2 ? this.a(X) : X < -i / 2 ? this.b(X) : this.c(X);
	        this.d(e, Y);
	    },
	    eachElement: function eachElement(it) {
	        return _react2.default.createElement(TodoElement, { sortToDoList: this.sortToDoList, data: it });
	    },
	    render: function render() {
	        return this.state.toDoList.map(this.eachElement(it));
	    }
	});
	ReactDOM.render(_react2.default.createElement(Form, null), document.getElementById('content'));
